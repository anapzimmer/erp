  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f7fafc] p-6">
      <section className="w-full max-w-xl rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-sm">
        ...
        <p className="mt-6 text-xs font-bold uppercase tracking-[0.22em] text-slate-500">PFV1F - Barra</p>
        <h1 className="mt-2 text-2xl font-black tracking-tight text-[#0f2742]">Página em construção</h1>
        <p className="mt-3 text-sm leading-6 text-slate-600">
          O cálculo por barra deste projeto ainda será montado.
        </p>
        <Link
