...
export default function JC2FKitPage() {
  ...
  const kitSelecionado = useMemo(() => {
    ...
    const kitsFiltrados = kits.filter((kit) => {
      ...
      const duasFolhasOk = /\b2\s*f\b|\b2\s*folhas?\b|2f/.test(textoKit);
    ...
    return kitsFiltrados
      ...
      .sort((a, b) => {
        ...
        const prioridadeA = /\b2\s*f\b|\b2\s*folhas?\b|2f/.test(textoA) ? 0 : 1;
        const prioridadeB = /\b2\s*f\b|\b2\s*folhas?\b|2f/.test(textoB) ? 0 : 1;
                  ...
                  if (label === "Imprimir") {
                    return (
                      <PDFDownloadLink
                        ...
                        fileName={`jc2f_kit_${dados.numero || "novo"}.pdf`}
                        className={itemClass}
                      >
                        {() => (
                          <>
