                        ...
                        {vidrosFiltrados.length > 0 ? (
                          vidrosFiltrados.map((v, i) => (
                            <div
                              ...
                              key={v.id}
                              className={`px-4 py-2 text-xs cursor-pointer flex justify-between items-center ${i === vidroIndex ? "bg-[#F4FFF0] text-[#1C415B] font-bold" : "hover:bg-gray-50 text-gray-600"
                                }`}
                              onClick={() => {
                                setVidroSel(v);
                                setBuscaVidro(formatarNomeVidro(v));
                          ...
                          {vidrosBandeiraFiltrados.length > 0 ? (
                            vidrosBandeiraFiltrados.map((v: any, i: number) => (
                              <div
                                ...
                                key={v.id}
                                className={`px-4 py-2 text-xs cursor-pointer flex justify-between items-center ${i === vidroBandeiraIndex ? "bg-[#F4FFF0] text-[#1C415B] font-bold" : "hover:bg-gray-50 text-gray-600"
                                  }`}
                                onClick={() => {
                                  setVidroSelBandeira(v);
                                  setBuscaVidroBandeira(formatarNomeVidro(v));
