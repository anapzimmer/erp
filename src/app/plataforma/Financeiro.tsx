...
export default function FinanceiroPanel() {
  ...
  return <div className={s.finance}>
    ...
    {loading && <p role="status" className="text-sm text-text-secondary">Carregando financeiro…</p>}
    {dados && <>
