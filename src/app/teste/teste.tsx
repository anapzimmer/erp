...
export default function CalculoEspelhosPage() {
  ...
  const [divisoesLargura, setDivisoesLargura] = useState(3);
  const [divisoesAltura, setDivisoesAltura] = useState(3);
        ...
        >
          <div
            style={{
              ...
              height: "100%",
              display: "grid",
              gridTemplateColumns: `repeat(${divisoesLargura}, 1fr)`,
              gridTemplateRows: `repeat(${divisoesAltura}, 1fr)`,
              gap: "6px",
              background: "#f1f5f9",
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ backgroundColor: theme.screenBackgroundColor }}>
      {/* Sidebar Container */}
      <div
        className={`${sidebarExpandido ? "w-64" : "w-20"} transition-all duration-300 hidden md:block h-full border-r border-gray-100 flex-shrink-0`}
