        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50 px-4">
          <div className="p-6 rounded-2xl shadow-lg w-full max-w-md bg-white">
            ...
            <div className="space-y-3">
              ...
              <input type="text" placeholder="Nome *" value={novoItem.nome} onChange={e => setNovoItem({ ...novoItem, nome: e.target.value })} className="w-full p-2 rounded-lg border" />
              <input type="text" placeholder="Cores" value={novoItem.cores} onChange={e => setNovoItem({ ...novoItem, cores: e.target.value })} className="w-full p-2 rounded-lg border" />
              ...
              <input type="text" placeholder="Categoria" value={novoItem.categoria} onChange={e => setNovoItem({ ...novoItem, categoria: e.target.value })} className="w-full p-2 rounded-lg border" />
